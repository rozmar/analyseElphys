...
if isfield(valtozok,'xcm_scatterplot')
    xcm_scatterplot=valtozok.xcm_scatterplot;
else
    xcm_scatterplot=xcm;
end
if isfield(valtozok,'ycm_scatterplot')
    ycm_scatterplot=valtozok.ycm_scatterplot;
else
    ycm_scatterplot=ycm;
end
...
if isfield(valtozok,'separateapwaves')
    separateapwaves=valtozok.separateapwaves;
else
    separateapwaves=1;
end
renderer='painters';
...
set(gcf,'PaperUnits','centimeters','PaperPositionMode','manual','PaperSize',[xcm_scatterplot/.5 ycm_scatterplot/.5]+2,'PaperPosition',[2 2 xcm_scatterplot/.5 ycm_scatterplot/.5])
...
print(gcf,[dirs.figuresdir,expname,'_apwaves_spontaneous_dv_v.jpg'],'-djpeg',['-r',num2str(dpi)])
    ...
    print(gcf,[dirs.figuresdir,expname,'_apwaves_all_dv_v.jpg'],'-djpeg',['-r',num2str(dpi)])
end