...
%persistent_generatefigures_plot_APwaves plots action potentials and saves
%them in the specified folder. The plots include voltage traces of spontaneous
%and stimulated action potentials, phase plots of spontaneous and
%stimulated action potentials, scatter plots showing threshold relative to
...
%           - APwaves: struct containing the data to be plotted. This
%           struct is generated by persistent_generatefigures_generate_APwaves
% Details of the valtozok struct:
% valtozok_APwaves_plot.markersize=5; (poins) - Markersize
% valtozok_APwaves_plot.linewidth=.5; (mm) - Linewidth of APs
% valtozok_APwaves_plot.highlight.Window=[0, 10] + valtozok_APwaves.zerotime;
%   (seconds from midnight (realtime)) - action potentials between these
%   two time points will be highlighted
% valtozok_APwaves_plot.highlight.idx=[32,100,44];% (indexes) - action
%   potentials in the APwaves struct with the specified indices are
%   highlighted
% valtozok_APwaves_plot.highlight.linewidth=1; (mm) - Linewidth of the
%   highlighted APs
% valtozok_APwaves_plot.xcm=3; (cm) - X size of the volage and dvoltage
%   plots
% valtozok_APwaves_plot.ycm=3; (cm) - Y size of the volage and dvoltage
%    plots
% valtozok_APwaves_plot.xcm_scatterplot=5; (cm) - X size of the scatter
%   plots
% valtozok_APwaves_plot.ycm_scatterplot=5; (cm) - Y size of the scatter
%   plots
% valtozok_APwaves_plot.fontsize=8; Font size
% valtozok_APwaves_plot.fonttype='Helvetica'; Font type
% valtozok_APwaves_plot.axeswidth=.5; (mm) Axes width
% valtozok_APwaves_plot.separateapwaves=1; (1/0) if voltage and dv plots
%   should be plotted on separate figures, or on the same figure with
%   subplots
% 
% see also persistent_generatefigures_plotselectedtimeinterval,
% persistent_generatefigures_generate_APwaves, persistent_generatefigures_human_rhythmic,
