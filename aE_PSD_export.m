...
% aE_PSD_export exports wavelet PSD for elphys data. The wavelet analysis
% uses calculateTFDPower.m by (Sándor Bordé)
% The inputs to this script is dirs, xlsdata (both generated by analysElphys_main.m
% script), and valtozok which is given by the user.
%
% valtozok.overwrite: (1/0) if the older files should be overwritten
% valtozok.analyseonlyfield: (1/0) if the analysis should only be done on
% extracellular recordings
% valtozok.downsamplenum: ('auto'/ integer) downsampling before PSD
% analysis (for compression)
% valtozok.high: (1/0) in which directory should we save the data
% valtozok.onlyawake: (1/0) if only experiments should be analyzed where
% the animal was awake
%
%See also calculateTFDPower
